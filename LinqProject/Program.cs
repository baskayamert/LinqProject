...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //AscDescProducts(products);

            //ClassicLinq(products); //This is a more sql style query

            //ClassicLinqII(products);
        ...
        private static void ClassicLinqII(List<Product> products)
        {
            var result = from p in products
        ...
        private static void AscDescProducts(List<Product> products)
        {
            //Single line query
        ...
        private static void FindAllProducts(List<Product> products)
        {
            var result = products.FindAll(p => p.ProductName.Contains("top"));
            Console.WriteLine(result);
        }

        private static void FindProduct(List<Product> products)
        {
            //lambda
        ...
        private static void AnyProduct(List<Product> products)
        {
